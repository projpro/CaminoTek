...
$$(document).on('page:init', function (e) {
    ...
    else if (pageURL.indexOf('carryout') > -1)//Carry Out
    {
       $("#txtFilterOrderDateFrom").flatpickr({
           ...
           //    var arrSelectedDate = dateStr.split('-');
           //    console.log("1:" + arrSelectedDate[1] + "/" + arrSelectedDate[2] + "/" + arrSelectedDate[0]);
           //    $$("#txtFilterOrderDateFrom").val(arrSelectedDate[1] + "/" + arrSelectedDate[2] + "/" + arrSelectedDate[0]);
           //},
           //disableMobile: false,
       ...
       $('#txtFilterOrderDateFrom').change(function () {
           var arrSelectedDate = $$('#txtFilterOrderDateFrom').val().split('-');
