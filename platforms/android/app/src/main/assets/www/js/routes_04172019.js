...
var routes = [
       ...
       [
          {
           ...
           {
               path: 'giftcard_loadredeem/',
               id: 'tab2',
               url: './pages/tabs/giftcard_loadredeem.html',
           },
           {
               path: 'giftcard_orders/',
               id: 'tab3',
               url: './pages/tabs/giftcard_orders.html',
           },
       ],
   },
   //{
  ...
  //{
  //    path: '/giftcard_orders/',
  //    url: './pages/giftcard_orders.html',
  //    name: 'giftcard_orders',
  //},
  //// Foods
  //{
  //    path: '/giftcard_new/',
  //    url: './pages/giftcard_new.html',
  //    name: 'giftcard_new',
  //},
  //// Foods
  //{
  //    path: '/giftcard_loadredeem/',
  //    url: './pages/giftcard_loadredeem.html',
  //    name: 'giftcard_loadredeem',
  //},
