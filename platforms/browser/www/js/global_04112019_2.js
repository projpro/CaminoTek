        ...
        $.getJSON(url, function (data) {
            ...
            $.each(JSON.parse(data), function (index, value) {
                ...
                if (pickupTime != undefined) {
                    if (status == '' || status == "All")
                        orderhtml += "<div class=\"order-pickup\">" + pickupTime + "</div>";
                    else
                        orderhtml += "<div class=\"order-pickup  order-pickup-margin-top\">" + pickupTime + "</div>";
                ...
                orderhtml += "<div class=\"giftcard-order-number\"><span class=\"order-number\"> #" + orderId + "</span> on " + orderDate + " @ " + orderTime + "</div>";
                /*------------------Button Row-----------------------*/
                if (orderStatus == "New") {
