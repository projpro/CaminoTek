...
$$(document).on('page:init', function (e) {
    ...
    if (pageURL == "/") {
        ...
        if (storeId > 0) {
            ...
            setTimeout(function () { self.app.router.navigate('/scan/', { reloadCurrent: false }); }, 1000);
    ...
    else if (pageURL.indexOf('scan') > -1)//Gift Card
    {
...
function InitPushNotification(storeId, name, uuid, version) {
    ...
    push.on('registration', function (data) {
        ...
        ////RegisterToken(storeId, data.registrationId, name, uuid, version);--By Sudip
