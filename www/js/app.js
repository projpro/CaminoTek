        ...
        $$('#btnPrintOrder').on('click', function () {            
            ...
            BTPrinter.connect(function (data) {
               ...
               BTPrinter.printBase64(function (data) {
                ...
                }, "\x1d\x21\x02\x02\x1d\x21\x05\x30 John Smith 1" + "\n");//Height(02) Width(20) Text
                ...
                $.each(JSON.parse(data), function (index, value) {
                    ...
                    if (value.Type == "OrderInfo") {
                        ...
                        BTPrinter.printImageUrl(function (data) {
                            ...
                            console.log("Error");
                            console.log(err);
                        }, "./www/img/app-logo-small.png", '1');//path image, align
                ...
                $.getJSON(urlItem, function (data) {
                        ...
                        $.each(JSON.parse(data), function (index, value) {
                            ...
                            if (value.NOTES != "") {
                                ...
                                if (showPriceInPrint) {
                                    ...
                                    //BTPrinter.printTextSizeAlign(function (data) {
                                    //}, function (err) {
                                    //}, "\n" + "\x1b\x45\x01 " + value.QUANTITY + "X  " + value.PRODUCT + "     " + FormatDecimal(value.TOTALPRICE) + " \x1b\x45\x00 " + "\n", '20', '0');
                                    ...
                                    //BTPrinter.printTextSizeAlign(function (data) {
                                    //}, function (err) {
                                    //}, "\n" + "\x1b\x45\x01 " + value.QUANTITY + "X  " + value.PRODUCT + " \x1b\x45\x00 " + "\n", '20', '0');
                                }
                    ...
                    if (showPriceInPrint) {
                        ...
                        if (discountValue != "" && discountValue != "0.00") {
                            ...
                            }, "\x1b\x50\x1b\x61\x02 " + "Coupon (" + couponCode + "): " + discountValue + "\n");
                        ...
                        if (rewardValue != "" && rewardValue != "0.00") {
                            ...
                            }, "\x1b\x50\x1b\x61\x02 " + "Reward (" + rewardPoints + "): -" + rewardValue + "\n");
                        ...
                        if (giftCardValue != "" && giftCardValue != "0.00") {
                            ...
                            }, "\x1b\x50\x1b\x61\x02 " + "Gift Card (" + giftCardCode + "): -" + giftCardValue + "\n");
